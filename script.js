...
function initializeWebGLWithImageTexture(image) {
    // Your existing WebGL initialization code goes here
    ...
    // Pass the texture to your shaders as a uniform
    var uTextureLocation = gl.getUniformLocation(displayProgram.program, 'uTexture');
    gl.uniform1i(uTextureLocation, 0); // 0 corresponds to texture unit 0

    // Rendering code using the texture
...
gl.clearColor(0.9, 0.2, 0.56, 1.0);
